...
import ElemCardList, { ISecondaryCardText } from "./ElemCardList";
import { action } from "@storybook/addon-actions";
import { DEFAULT_LIST_BLUE } from "../elemList/ElemList";
...
const getSecondary1 = (elem: any) => ({ text: elem.days });
const getSecondary2 = (elem: any): ISecondaryCardText => ({
  text: elem.exercises,
...
export const emptyList = () => (
  <ElemCardList data={emptydataList} noDataMsg="No data available" />
);
