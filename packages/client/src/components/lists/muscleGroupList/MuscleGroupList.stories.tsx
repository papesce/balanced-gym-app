...
import {
  sampleRoutine1,
  routineWithEmptyGroup,
  routineWithSingleGroup,
  routineWithFullGroup
...
export const errorList = () => (
  <MuscleGroupList error="fetch error message ignored" />
);
export const noGroupList = () => <MuscleGroupList routine={sampleRoutine1} />;
export const emptyGroupList = () => (
  <MuscleGroupList routine={routineWithEmptyGroup} />
);
export const singleGroupList = () => (
  <Router>
    <MuscleGroupList
      routine={routineWithSingleGroup}
